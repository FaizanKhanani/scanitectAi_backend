...
//   // NEW: strip ".jpg" / ".png" etc. and convert to ObjectId
//   private toObjectId(idWithMaybeExt: string): ObjectId {
//     const hex = idWithMaybeExt.split('.')[0]; // "abc123.jpg" -> "abc123"
...
//     const bucket = this.getBucket(bucketName);
//     try {
//       // CHANGED: use toObjectId
//       await bucket.delete(this.toObjectId(fileId));
//       return true;
//     } catch {
//       return false;
//     }
...
//       .find({ _id: this.toObjectId(fileId) })
//       .toArray();
//     return file;
//   }
...
//     const bucket = this.getBucket(bucketName);
//     // CHANGED: use toObjectId
//     return bucket.openDownloadStream(this.toObjectId(fileId));
//   }
